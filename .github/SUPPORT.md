To get help, you can say hello in [Slack](https://devtools-html.slack.com/) or in the #devtools-html channel on irc.mozilla.org.

There are lots of helpful folks in [Slack](https://devtools-html.slack.com/) who would be happy to help.
