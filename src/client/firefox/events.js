...
async function paused(threadClient: ThreadClient, _: "paused", packet: PausedPacket) {
...
function resumed(threadClient: ThreadClient, _: "resumed", packet: ResumedPacket) {
...
function newSource(threadClient: ThreadClient, _: "newSource", { source }: SourcePacket) {
