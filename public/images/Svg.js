...
const svg = {
  ...
  "pause-all-exceptions": require("./pause-all-exceptions.svg"),
  "pause-ignore-exceptions": require("./pause-ignore-exceptions.svg"),
  "pause-uncaught-exceptions": require("./pause-uncaught-exceptions.svg"),  
