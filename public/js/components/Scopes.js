...
function renderArgumentProperty(argumentBinding) {
  ...
  return dom.li({className: "scope-property-list-item", key: actor},
    argumentName
  );
}
...
function renderScopeBindings(bindings) {
  ...
  return dom.ul({className: "scope-property-list"},
...
function renderFunctionScope(scope, isFirst) {
  ...
  return dom.li({ className: "scope-item", key: scope.get("actor") },
